...
class BiseCorrections_model extends CI_Model
{
    ...
    public function getmigration($class)
    {
        if($class == 9)
        {
            $table1= 'Admission_online..tblRegMig';
            ...
            $this->db->where("$table2.isdeleted = 0 and $table1.iyear =  2016 and $table1.class=9"); 
        }
        if($class == 10)
        {
            $table1= 'Admission_online..tblAdmMig';
            ...
            $this->db->where("$table1.iyear =  2016 and $table1.class=9 and $table1.ismigrated is null");  
        }
    ...
    public function updateMigData($formno,$newInst,$oldInst,$kpo){
      ...
      public function update10MigData($formno,$kpo,$isupdate){
        ...
        $res =  $this->db->update(TBLMIGRATION1, $data2);
