<?php
  class EleventhCorrection_model extends CI_Model 
{
      ...
      public function GetAppNo()
    {
        ...
        $appno = $this->db->get_where('Registration..IA_P1_Reg_Correction');
    ...
    {
        $q2         = $this->db->get_where('Registration..RuleFee_Reg_Eleventh_Correction',array('Rule_Fee_ID'=>$ruleID));
...
//       DebugBreak();
        $query = $this->db->query("Registration..IA_P1_Reg_Correction_sp_insert '$formno',11,2016,1,'$name','$fname','$BForm','$FNIC','$Dob',$grp_cd,$sub1,$sub2,$sub3,$sub4,$sub5,$sub6,$sub7,$sub8,$Pic,$Inst_cd,$RegGrp,$NameFee,$FnameFee,$BFormFee,$DobFee,$FNICFee,$grpFee,$subFee,$picFee,$totalFee,$AppNo");
      ...
      public function EditEnrolement($inst_cd)
    {
        ...
        $query = $this->db->query("Registration..sp_get_regInfo_Correction_11th $inst_cd,11,2016,1");    
    ...
    public function Print_challan_Form($fetch_data)
    {
     ...
     // DebugBreak();
        $query = $this->db->query("Registration..sp_get_regInfo_correction_challan_11th $Inst_cd,11,2016,1,'$formno'");
        $rowcount = $query->num_rows();
        if($rowcount > 0)
        {
            return $query->result_array();
    ...
    public function Print_corr_Form_Final($fetch_data)
    {
        ...
        $query = $this->db->query("Registration..sp_get_reg_Print_Form_Correction_11th $Inst_cd,$AppNo");
        $rowcount = $query->num_rows();
        if($rowcount > 0)
        {
            return $query->result_array();
    ...
    public function EditEnrolement_Applied($inst_cd)
    {
        ...
        $query = $this->db->query("Registration..sp_get_regInfo_after_Correction_11th $inst_cd,11,2016,1");    
    ...
    public function EditEnrolement_Branch()
    {
       ...
       // DebugBreak();
        ...
        $query = $this->db->query("Registration..sp_get_regInfo_after_Correction_Branch_11th 11,2016,1");    
    ...
    public function Delete_Corr_App($AppNo)
    {
        ...
        $this->db->update('Registration..IA_P1_Reg_Correction',$data);
        return true;
