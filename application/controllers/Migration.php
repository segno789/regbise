...
class Migration extends CI_Controller {
    ...
    */
    ...
    public function updatefrom()
    {
     ...
     public function updatefrom_byRollNo()
    {
           //  DebugBreak();
        $this->load->library('session');
        $Logged_In_Array = $this->session->all_userdata();
    ...
    {    
     ...
     public function release_stdForm11th_byRollNo($formno)
    {    
                // DebugBreak();
        $this->load->library('session');
        $Logged_In_Array = $this->session->all_userdata();
        ...
        $this->load->view('common/menu.php',$data);
        $this->load->view('migration/11thmigration_form_byRollNo.php',$RegStdData);   
        $this->commonfooter(array("files"=>array("jquery.maskedinput.js","validate.NewEnrolment.js"))); 
