...
class Privateslips extends CI_Controller {
    ...
    */
    ...
    private function makepdf($pdf,$info)
    {
        ...
        if($info['grp_cd'] == 1)  $grp_cd = 'SCIENCE'; else if($info['grp_cd'] == 2) $grp_cd='GENERAL';else if($info['grp_cd'] == 4) $grp_cd='AAMA GROUP';
        ...
        $pdf->Image("assets/img/Note00.jpg",10.0,263, 145,30, "JPG"); 
        $pdf->SetFont('Arial','',8);
        $pdf->SetXY(160,287);
    ...
    private function makepdf9thclass($pdf,$info)
    {
        ...
        if($info['Session'] ==1) $Session= 'ANNUAL'; else $Session='SUPPLY';
        //if($info['errmessage'] == null) ; else{ $errmessage = ' (PROVISIONALLY OBJECTION SLIP)';};
        $errmessage = '(PROVISIONALLY)';
