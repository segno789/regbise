...
matric_sub1 = 0
        ...
        $("#sub1p2").prepend("<option  value='2'> URDU </option>");
        ...
        $("#sub6").append(new Option('NONE',0));
         $("#sub6p2").append(new Option('Biology',46));
    }
    ...
    function load_Hum(){
       ...
       $("#sub1").append(new Option('NONE',0));  
        ...
        $("#sub6 option[value='0']").attr("selected","selected");
         ...
         $("#sub5 option[value='<?php echo @$data[0]['sub5']   ?>']").attr("selected","selected"); 
         $("#sub6 option[value='<?php echo @$data[0]['sub6']   ?>']").attr("selected","selected"); 
         $("#sub4p2 option[value='<?php echo @$data[0]['sub4']   ?>']").attr("selected","selected"); 
         $("#sub5p2 option[value='<?php echo @$data[0]['sub5']   ?>']").attr("selected","selected"); 
         $("#sub6p2 option[value='<?php echo @$data[0]['sub6']   ?>']").attr("selected","selected"); 
