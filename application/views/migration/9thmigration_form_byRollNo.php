            ...
            <div class="span12">
                <div class="widget">
                    ...
                    <div class="widget-body">
                        ...
                        <form class="form-horizontal no-margin" action="<?php  echo base_url(); ?>Migration/updatefrom_byRollNo" method="post" enctype="multipart/form-data">

                            <div class="control-group">
                                <h4 class="span4">Personal Information :</h4>
                                <div class="controls controls-row">
                                    <input type="hidden" class="span2 hidden" id="formno" name="rno" value="<?=  $data['0']['rno']?>">
