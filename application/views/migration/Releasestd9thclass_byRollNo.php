...
function downloadchallan(app_id,ischallan)
{
    if(ischallan == 2)
    {
     window.location.href = '<?=base_url()?>Migration/Print_migration_Form_Final_byRollNo/'+app_id;   
    }
    else if(ischallan == 1)
    {
      window.location.href = '<?=base_url()?>Migration/Print_challan_Form_byRollNo/'+app_id;      
    }
