            ...
            <div class="span12">
                <div class="widget no-margin">
                    <div class="widget-header">
                        <div class="title">
                             11th Registration<a data-original-title="" id="notifications">s</a>
                        </div>
                            ...
                            <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">
                                ...
                                <tbody>
                                   ...
                                   // DebugBreak();
                                    ...
                                    echo'<td>
                                    <button type="button" class="btn btn-info" value="'.$formno.'" onclick="releasemForm11th('.$formno.')">Release</button>
                                    </td>
                                    </tr>';
                                    endforeach;
                                    }
