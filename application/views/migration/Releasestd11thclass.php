            ...
            <div class="span12">
                <div class="widget no-margin">
                    <div class="widget-header">
                        <div class="title">
                            Release 11th Registration Students<a data-original-title="" id="notifications"></a>
                        </div>
                            ...
                            <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">
                                ...
                                <tbody>
                                   ...
                                   $PicPath = $formno.'.jpg';
                                    ...
                                    <td>'.$vals["name"].'</td>
                                    <td>'.$vals["fname"].'</td>
                                     <td><img id="previewImg" style="width:40px; height: 40px;" src="/'.IMAGE_PATH11.$Inst_Id.'/'.$PicPath.'?'.rand(10000,1000000).'" alt="Candidate Image"></td>';
                                    echo'<td>
...
function downloadchallan(app_id,ischallan)
{
    if(ischallan == 2)
    {
     window.location.href = '<?=base_url()?>Migration/Print_migration_Form_Final11th/'+app_id;   
    }
    else if(ischallan == 1)
    {
