            ...
            <div class="span12">
                <div class="widget">
                    ...
                    <div class="widget-body">
                        ...
                        <form class="form-horizontal no-margin" action="<?php  echo base_url(); ?>Migration/updatefrom11th_byRollNo" method="post" enctype="multipart/form-data">

                            <div class="control-group">
                                <h4 class="span4">Personal Information :</h4>
                                <div class="controls controls-row">
                                    <input type="hidden" class="span2 hidden" id="rno" name="rno" value="<?=  $data['0']['rno']?>">
                            ...
                            <div class="control-group">
                                ...
                                <label id="ErrMsg" class="control-label span2" style=" text-align: left;    font-size: 22px;font-weight: bold;">Rno. <?= $data['0']['rno']?></label>
