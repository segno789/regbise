        ...
        <div class="span12">
            <div class="widget">
                ...
                <div class="widget-body">
                    <form class="form-horizontal no-margin" action="<?php echo base_url(); ?>/index.php/BiseCorrection/searchbyinst11thDelete_candidate" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    function delForm11(fromno)
    {
        
        var win = window.open('<?php echo base_url(); ?>BiseCorrection/NewEnrolment_EditForm11/'+fromno, '_blank');
  win.focus();
