<div class="widget">
    ...
    <div class="widget-body">
        ...
        <form class="form-horizontal no-margin" id="SpecForm" action="<?php echo base_url(); ?>index.php/BiseCorrection/SpecPermison_9th_INSERT" method="post" >
            ...
            <div class='control-group'>
              ...
              <div class='control-group'>
                ...
                <div class='controls controls-row'>
                    ...
                    <input class='span3 form-control' id='Reg_fee' name='Reg_fee' style='text-transform: uppercase;' type='number' placeholder="REGISTRATION FEE"  required='required'  value="1000" readonly="readonly" >
                </div>
            </div>
            <div class='control-group'>
