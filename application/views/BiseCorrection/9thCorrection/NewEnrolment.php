                    ...
                    <div class="widget-body">
                        ...
                        <form class="form-horizontal no-margin" action="<?php echo base_url(); ?>/index.php/Registration/NewEnrolment_insert" method="post" enctype="multipart/form-data">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls controls-row">
                                    <input class="span3" type="text" id="cand_name" style="text-transform: uppercase;" name="cand_name" placeholder="Candidate Name" value = "<?php  if(($excep != "")&& ($excep['excep'] != "success")){echo strtoupper($excep['cand_name']) ;} else {echo '';}?>" maxlength="60" tabindex="1">
                                    <label class="control-label span2" for="lblfather_name">
                                        Father's Name :
                                    </label> 
                                    <input class="span3" id="father_name" name="father_name" style="text-transform: uppercase;" type="text" placeholder="Father's Name" value="<?php if (($excep != "") && ($excep['excep'] != "success")){echo strtoupper($excep['father_name']) ;} else {echo '';} ?>" required="required" maxlength="60" tabindex="2">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label span1" >
                                ...
                                <div class="controls controls-row">
                                    <input class="span3" type="text" id="bay_form" name="bay_form" placeholder="Bay Form No." value="<?php if (($excep != "") && ($excep['excep'] != "success")){echo $excep['bay_form'];} else {echo '';} ?>" required="required" tabindex="3">
