                    ...
                    <div class="widget-body">
                        ...
                        <form class="form-horizontal no-margin" action="<?php  echo base_url(); ?>index.php/BiseCorrection/NewEnrolment_insert_OtherBoard11th" method="post" enctype="multipart/form-data" name="myform" id="myform">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls controls-row">
                                    <input class="span3" type="text" id="oldrno" style="text-transform: uppercase;" name="soldrno"  required="required" maxlength="60" >
                                    <label class="control-label span2" >
                                        Year:
                                    </label> 
                                    <select class="span3"  name="soldyear" id = "soldyear" >
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls controls-row">
                                    <select class="span3" id="soldsess" name="soldsess">
                                    ...
                                    <select class="span3" id="soldboard" name="soldboard">
                                        <option value="2" <?php if(@$oldBrd_cd == 1) echo 'selected' ?>>BISE,  GUJRANWALA</option>
