            ...
            <div class="span12">
                <div class="widget">
                    ...
                    <div class="widget-body">
                        ...
                        <form class="form-horizontal no-margin" action="<?php echo base_url(); ?>/index.php/Registration_11th/Batchlist_INSERT" method="post" >
...
<script type="text/javascript">
    function CancelAlert()
    {
        ...
        alertify.confirm(msg, function (e) {
            if (e) {
                // user clicked "ok"
                window.location.href ="<?php echo base_url(); ?>index.php/Registration_11th/Batchlist";
            } else {
                // user clicked "cancel"
