            ...
            <div class="span12">
                <div class="widget">
                    ...
                    <div class="widget-body">
                     <form class="form-horizontal no-margin" action="<?php echo base_url(); ?>/index.php/Registration_11th/Profile_Update" method="post" enctype="multipart/form-data">
  ...
  function CancelAlert()
    {
        ...
        alertify.confirm(msg, function (e) {
            if (e) {
                // user clicked "ok"
                window.location.href ="<?php echo base_url(); ?>index.php/Registration_11th/index/7";
            } else {
                // user clicked "cancel"
